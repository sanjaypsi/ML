...
class InactivityDetector:
    ...
    def print_time_every_minute(self):
        """
        Prints the current time every minute.

        This method checks if 60 seconds have passed since the last time it was called,
        and if so, it prints the current time in 'YYYY-MM-DD HH:MM:SS' format.
